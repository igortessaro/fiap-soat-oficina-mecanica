    ...
    public partial class AddInitialsTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_available_services_supply", x => new { x.AvailableServicesId, x.SuppliesId });
                    table.ForeignKey(
                        name: "FK_available_services_supply_available_services_AvailableServic~",
                        column: x => x.AvailableServicesId,
                        principalTable: "available_services",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_available_services_supply_supplies_SuppliesId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    AvailableServicesId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    ServiceOrdersId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_available_services_services_orders", x => new { x.AvailableServicesId, x.ServiceOrdersId });
                    table.ForeignKey(
                        name: "FK_available_services_services_orders_available_services_Availa~",
                        column: x => x.AvailableServicesId,
                        principalTable: "available_services",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_available_services_services_orders_service_orders_ServiceOrd~",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_available_services_services_orders_ServiceOrdersId",
                table: "available_services_services_orders",
                column: "ServiceOrdersId");

            migrationBuilder.CreateIndex(
                name: "IX_available_services_supply_SuppliesId",
