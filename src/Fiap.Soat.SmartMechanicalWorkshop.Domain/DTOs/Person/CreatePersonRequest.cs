...
public record CreatePersonRequest([Required][MaxLength(255)] string Fullname, [Required][MaxLength(100)] string Document, [Required] PersonType PersonType, EmployeeRole? EmployeeRole, [Required][MaxLength(255)] string Email, [Required][MaxLength(255)] string Password, CreatePhoneRequest Phone, CreateAddressRequest Address);
