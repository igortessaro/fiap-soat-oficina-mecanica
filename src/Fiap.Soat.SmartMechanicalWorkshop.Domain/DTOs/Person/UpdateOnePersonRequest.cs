...
public record UpdateOnePersonRequest(string Fullname, string Document, PersonType PersonType, EmployeeRole? EmployeeRole, string Email, string Password, UpdateOnePhoneRequest? Phone, UpdateOneAddressRequest? Address);
