...
public record CreateClientRequest([Required][MaxLength(255)] string Fullname, [Required][MaxLength(100)] string Document, [Required] EPersonType PersonType, EEmployeeRole? EmployeeRole, [Required][MaxLength(255)] string Email, CreatePhoneRequest Phone, CreateAddressRequest Address);
